		...
		},
		{
			...
			tr: {
				...
				kz: {
					...
					intro_content: "<p>2021 жылдан бастап Ольга ресечерден бағыт жетекшісіне дейінгі жолдан өтіп, Executive Search (Middle &amp; Top) қызметтерін ең жоғары деңгейде қамтамасыз ететін жүйе құрды.</p><p>Рекрутингте табыс кездейсоқ болмайды — ол жүйелі әдіснаманың тікелей нәтижесі. REC-A-да бұл әдіснаманы негізін қалаушы әрі Жетекші сарапшы әзірлеп, енгізді.</p><p>Әрбір жоба қатаң регламенттер мен стандарттардан өтеді. Әдіснама мен бағалау сапасын Жетекші сарапшы жеке бақылайды. Біз құзыреттер бойынша объективті сұхбатқа кепілдік беріп, ретсіз таңдау тәуекелдерін азайтамыз.</p>",
					principles_heading: "REC-A жүйесі негізделген қағидаттар",
				},
				en: {
					eyebrow_title: "Founder and Lead Expert of REC-A", name: "Olga V.",
					intro_content: "<p>Since 2021, Olga has grown from a researcher into a practice lead, building a system that delivers Executive Search (Middle &amp; Top) at the highest level.</p><p>In recruiting, success is never accidental — it is the direct result of a systematic methodology. At REC-A this methodology was designed and implemented by the Founder and Lead Expert.</p><p>Every project follows strict rules and standards. The Lead Expert personally oversees methodology and assessment quality. We guarantee objective competency-based interviews and minimise the risks of chaotic hiring.</p>",
		...
		},
		{
			...
			items: [
				...
				{ icon: "quality", sort: 2, tr: {
					...
					kz: { title: "Сапа", text: "Біз жұмысымыздың әр кезеңінде жоғары сапа мен сервис стандарттарын ұстанамыз — талаптарды анықтаудан бастап түпкі нәтижеге дейін бірінші дәрежелі көзқарасты қамтамасыз етеміз." },
					en: { title: "Quality", text: "We uphold high standards of quality and service at every stage — a first-class approach from defining requirements to delivering the final result." } } },
