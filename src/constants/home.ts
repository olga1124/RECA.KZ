...
export const categories: ServiceCardProps[] = [
    {
        ...
        text: "Полный цикл рекрутинга: анализ, поиск, отбор и привлечение кандидатов, обладающих всеми навыками, соответствующими текущим и долгосрочным стратегическим планам вашег бизнеса",
        btnTitle: "Подробнее",
        path: "/employers"
    },
