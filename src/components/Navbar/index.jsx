            ...
            <div className="container flex justify-between items-center">
                <div className="block">
                    <Link
                        ...
                        rel="noreferrer"
                    >
                        <Image src="/logo.svg" alt="Nelcosoft logo" width={130} height={70} />
                    </Link>
                </div>
                    ...
                    <ul className="nav-links-container hidden md:flex">
                        {navbarLinks.map(({ title, path }) => (
                            <li
                                ...
                                className="nav-links px-4 cursor-pointer capitalize font-medium text-gray-500 hover:scale-105 hover:text-gray duration-200 link-underline"
                            >
                                <Link href={path} smooth={"true"} scroll={true} duration={300}>{title}</Link>
                            </li>
                        ))}
                    </ul>
