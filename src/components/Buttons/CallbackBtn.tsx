...
import styles from "./CallbackBtn.module.css";

/** Floating WhatsApp callback button. Number comes from site settings. */
const CallbackBtn: FC<{ phone?: string }> = ({ phone }) => {
	const digits = (phone ?? "+7 775 888 72 03").replace(/\D/g, "");
	return (
		<a href={`https://wa.me/${digits}`} target="_blank" rel="noreferrer" className={styles.btn} aria-label="WhatsApp">
